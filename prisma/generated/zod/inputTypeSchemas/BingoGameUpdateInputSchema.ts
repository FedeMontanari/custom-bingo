...
import { BingoCardUpdateManyWithoutGameNestedInputSchema } from './BingoCardUpdateManyWithoutGameNestedInputSchema';

export const BingoGameUpdateInputSchema: z.ZodType<Prisma.BingoGameUpdateInput> = z.object({
  ...
  BingoCard: z.lazy(() => BingoCardUpdateManyWithoutGameNestedInputSchema).optional()
}).strict();

export default BingoGameUpdateInputSchema;
