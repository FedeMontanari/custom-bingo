...
export const CardStateFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CardStateFindUniqueOrThrowArgs> = z.object({
  select: CardStateSelectSchema.optional(),
  include: z.lazy(() => CardStateIncludeSchema).optional(),
  where: CardStateWhereUniqueInputSchema,
}).strict() ;

export default CardStateFindUniqueOrThrowArgsSchema;
