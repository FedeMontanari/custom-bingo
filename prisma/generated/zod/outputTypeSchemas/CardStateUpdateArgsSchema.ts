...
export const CardStateUpdateArgsSchema: z.ZodType<Prisma.CardStateUpdateArgs> = z.object({
  select: CardStateSelectSchema.optional(),
  include: z.lazy(() => CardStateIncludeSchema).optional(),
  data: z.union([ CardStateUpdateInputSchema,CardStateUncheckedUpdateInputSchema ]),
  where: CardStateWhereUniqueInputSchema,
}).strict() ;

export default CardStateUpdateArgsSchema;
