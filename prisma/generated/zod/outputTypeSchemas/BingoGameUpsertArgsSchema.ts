...
export const BingoGameUpsertArgsSchema: z.ZodType<Prisma.BingoGameUpsertArgs> = z.object({
  select: BingoGameSelectSchema.optional(),
  include: z.lazy(() => BingoGameIncludeSchema).optional(),
  where: BingoGameWhereUniqueInputSchema,
  create: z.union([ BingoGameCreateInputSchema,BingoGameUncheckedCreateInputSchema ]),
  update: z.union([ BingoGameUpdateInputSchema,BingoGameUncheckedUpdateInputSchema ]),
}).strict() ;

export default BingoGameUpsertArgsSchema;
